...
exports.broadcast = function(req,res, callback) {  
	...
	var form = new formidable.IncomingForm();
        var lengthTime, amountEnergy;
	//Parsing the HTML form
	form.parse(req, function (err, fields, files) {
		//Getting both variables from form
		lengthTime = fields.length;
		amountEnergy = fields.amountEnergy
                //TODO:Laura Same problem. This functionis asynchronous. Therefore vales are not ready when we try to assign them. Also I changed them from local to global. (deleted "var")
